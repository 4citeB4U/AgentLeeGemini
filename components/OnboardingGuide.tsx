...
TAG: AGENT_LEE_ONBOARDING_GUIDE
COLOR_ONION_HEX: NEON=#8B5CF6 FLUO=#7C3AED PASTEL=#DDD6FE
ICON_FAMILY: lucide
ICON_GLYPH: compass
ICON_SIG: AL002011
5WH: WHAT=Interactive onboarding and tutorial system; WHY=User education and feature introduction; WHO=Agent Lee Development Team; WHERE=D:\Agent-Lee_System\components\OnboardingGuide.tsx; WHEN=2025-09-22; HOW=React component with step-by-step guidance
...
const OnboardingGuide: React.FC<OnboardingGuideProps> = ({ onComplete, onTabClick, onNameSet }) => {
